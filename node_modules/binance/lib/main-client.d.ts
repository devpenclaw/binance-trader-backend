...
export declare class MainClient extends BaseRestClient {
    ...
    submitNewOrderListOPO(params: NewOrderListOPOParams): Promise<NewOrderListOPOResponse>;
    submitNewOrderListOPOCO(params: NewOrderListOPOCOParams): Promise<NewOrderListOPOCOResponse>;
     ...
     *
     **/
    getOnchainYieldsLockedProducts(params?: OnchainYieldsLockedProductListParams): Promise<OnchainYieldsLockedProductListResponse>;
    getOnchainYieldsLockedPersonalLeftQuota(params: OnchainYieldsLockedPersonalLeftQuotaParams): Promise<OnchainYieldsLockedPersonalLeftQuotaResponse>;
    getOnchainYieldsLockedPosition(params?: OnchainYieldsLockedPositionParams): Promise<OnchainYieldsLockedPositionResponse>;
     ...
     *
     **/
    getOnchainYieldsLockedSubscriptionPreview(params: OnchainYieldsLockedSubscriptionPreviewParams): Promise<OnchainYieldsLockedSubscriptionPreviewResponse>;
    subscribeOnchainYieldsLockedProduct(params: OnchainYieldsLockedSubscribeParams): Promise<OnchainYieldsLockedSubscribeResponse>;
    setOnchainYieldsLockedAutoSubscribe(params: OnchainYieldsLockedSetAutoSubscribeParams): Promise<OnchainYieldsLockedSetAutoSubscribeResponse>;
    setOnchainYieldsLockedRedeemOption(params: OnchainYieldsLockedSetRedeemOptionParams): Promise<OnchainYieldsLockedSetRedeemOptionResponse>;
    redeemOnchainYieldsLockedProduct(params: OnchainYieldsLockedRedeemParams): Promise<OnchainYieldsLockedRedeemResponse>;
    /**
     *
     * STAKING - Onchain Yields - History
     *
     **/
    getOnchainYieldsLockedSubscriptionRecord(params?: OnchainYieldsLockedSubscriptionRecordParams): Promise<OnchainYieldsLockedSubscriptionRecordResponse>;
    getOnchainYieldsLockedRewardsHistory(params?: OnchainYieldsLockedRewardsHistoryParams): Promise<OnchainYieldsLockedRewardsHistoryResponse>;
    getOnchainYieldsLockedRedemptionRecord(params?: OnchainYieldsLockedRedemptionRecordParams): Promise<OnchainYieldsLockedRedemptionRecordResponse>;
    /**
     *
     * STAKING - Soft staking
     *
     **/
    getSoftStakingProductList(params?: GetSoftStakingProductListParams): Promise<GetSoftStakingProductListResponse>;
    setSoftStaking(params: SetSoftStakingParams): Promise<SetSoftStakingResponse>;
    getSoftStakingRewardsHistory(params?: GetSoftStakingRewardsHistoryParams): Promise<GetSoftStakingRewardsHistoryResponse>;
    /**
     *
    ...
    fiatWithdraw(params: WithdrawFiatParams): Promise<{
        id: string;
    }>;
    fiatDeposit(params: FiatDepositParams): Promise<FiatDepositResponse>;
    getFiatOrderDetail(params: GetFiatOrderDetailParams): Promise<GetFiatOrderDetailResponse>;
    /**
     *
     * Rebate Endpoints
     *
     ...
     *
     **/
    getInstLoanRiskUnit(params?: GetInstitutionalLoanRiskUnitDetailsParams): Promise<InstitutionalLoanRiskUnitDetails[]>;
    closeInstLoanRiskUnit(): Promise<CloseInstitutionalLoanRiskUnitResponse>;
    addInstLoanCollateralAccount(params: AddInstitutionalLoanCollateralAccountParams): Promise<object>;
    getActiveInstLoanRiskUnits(): Promise<ActiveInstitutionalLoanRiskUnit[]>;
    getClosedInstLoanRiskUnits(params?: GetClosedInstitutionalLoanRiskUnitsParams): Promise<GetClosedInstitutionalLoanRiskUnitsResponse>;
    /**
     *
     * INSTITUTIONAL LOAN - Trade Endpoints
     *
     **/
    getInstLoanForceLiquidationRecord(params: GetInstitutionalLoanForceLiquidationParams): Promise<GetInstitutionalLoanForceLiquidationResponse>;
    /**
     *
     * INSTITUTIONAL LOAN -  TransferEndpoints
     *
     **/
    transferInstLoanRiskUnit(params: InstitutionalLoanRiskUnitTransferParams): Promise<null>;
    /**
     *
     * INSTITUTIONAL LOAN - Borrow/Repay Endpoints
     *
     **/
    borrowInstitutionalLoan(params: InstitutionalLoanBorrowParams): Promise<InstitutionalLoanBorrowResponse>;
    getInstLoanInterestHistory(params?: GetInstitutionalLoanInterestHistoryParams): Promise<InstitutionalLoanInterestHistoryResponse>;
    repayInstitutionalLoan(params: InstitutionalLoanRepayParams): Promise<InstitutionalLoanRepayResponse>;
    getInstLoanBorrowRepayRecords(params: GetInstitutionalLoanBorrowRepayRecordsParams): Promise<GetInstitutionalLoanBorrowRepayRecordsResponse>;
    /**
     *
     ...
     * @deprecated
     */
    getBrokerSpotRebateHistory(days: 7 | 30, customerId?: string): import("./util/requestUtils").GenericAPIResponse | undefined;
    /**
