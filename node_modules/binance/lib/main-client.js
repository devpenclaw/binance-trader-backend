...
class MainClient extends BaseRestClient_1.default {
     ...
     *
     **/
    getInstLoanForceLiquidationRecord(params) {
        return this.getPrivate('sapi/v1/margin/loan-group/force-liquidation', params);
    }
    /**
     *
     ...
     *
     **/
    transferInstLoanRiskUnit(params) {
     ...
     *
     **/
    borrowInstitutionalLoan(params) {
        return this.postPrivate('sapi/v1/margin/loan-group/borrow', params);
    }
    getInstLoanInterestHistory(params) {
        return this.getPrivate('sapi/v1/margin/loan-group/interest-history', params);
    }
    repayInstitutionalLoan(params) {
        return this.postPrivate('sapi/v1/margin/loan-group/repay', params);
    }
    getInstLoanBorrowRepayRecords(params) {
     ...
     */
    getAlphaTokenList() {
        return this.getForBaseUrl('bapi/defi/v1/public/wallet-direct/buw/wallet/cex/alpha/all/token/list', 'www');
    }
    getAlphaExchangeInfo() {
        return this.getForBaseUrl('bapi/defi/v1/public/alpha-trade/get-exchange-info', 'www');
    }
    getAlphaAggTrades(params) {
        return this.getForBaseUrl('bapi/defi/v1/public/alpha-trade/agg-trades', 'www', params);
    }
    getAlphaKlines(params) {
        return this.getForBaseUrl('bapi/defi/v1/public/alpha-trade/klines', 'www', params);
    }
    getAlphaTicker(params) {
        return this.getForBaseUrl('bapi/defi/v1/public/alpha-trade/ticker', 'www', params);
    }
    /**
     *
    ...
    validateOrderId(params, orderIdProperty) {
        ...
        const expectedOrderIdPrefix1 = `x-${(0, requestUtils_1.getOrderIdPrefix)(apiCategory, 'v1')}`;
        const expectedOrderIdPrefix2 = `x-${(0, requestUtils_1.getOrderIdPrefix)(apiCategory, 'v2')}`;
        if (!params[orderIdProperty].startsWith(expectedOrderIdPrefix1) &&
            !params[orderIdProperty].startsWith(expectedOrderIdPrefix2)) {
            (0, requestUtils_1.logInvalidOrderId)(orderIdProperty, expectedOrderIdPrefix1, params);
        }
    }
    /**
     *
