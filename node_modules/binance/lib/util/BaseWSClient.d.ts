...
import { SignKeyType } from './webCryptoAPI';
...
TWSKey extends string, TWSRequestEvent extends object> extends EventEmitter {
    ...
    setAuthOnConnect(enabled: boolean): this;
    setAuthEveryRequest(enabled: boolean): this;
    /**
    ...
    getCachedMidFlightRequest(wsKey: TWSKey, requestKey: string): TWSRequestEvent | undefined;
    removeCachedMidFlightRequest(wsKey: TWSKey, requestKey: string): void;
    /**
