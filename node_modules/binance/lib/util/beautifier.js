        ...
        for (const propertyKey in data) {
            ...
            if (!Array.isArray(value)) {
                if (valueType === 'object' && value !== null) {
                    newItem[newKey] = this.beautify(value, knownBeautification[propertyKey]);
                }
                else {
            ...
            if (Array.isArray(this.beautificationMap[newKey])) {
                ...
                for (const elementValue of value) {
                    const mappedBeautification = this.beautificationMap[knownBeautification[propertyKey]];
