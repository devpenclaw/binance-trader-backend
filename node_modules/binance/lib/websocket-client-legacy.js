...
class WebsocketClientV1 extends events_1.EventEmitter {
    constructor(options, logger) {
        ...
        this.options = Object.assign({ 
            ...
            authPrivateRequestsIndividually: true }, options);
        this.wsUrlKeyMap = {};
    ...
    subscribeUsdFuturesUserDataStream(isTestnet, forceNewConnection, isReconnecting) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const restClient = this.restClientCache.getUSDMRestClient(Object.assign(Object.assign({}, this.getRestClientOptions()), { testnet: isTestnet }), this.options.requestOptions);
